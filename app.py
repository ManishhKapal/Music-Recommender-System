...
with col2:
    st.image("images\Black and Red Music Studio Logo.png" , width=300, use_column_width=True)

with col3:
    st.write("")

st.title("Sangeet")
st.write('Sangeet is an emotion detection based music reccommendation system. To get song recommendations, start by allowing mic and camera for this web app.')
